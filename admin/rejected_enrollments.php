...
<head>
<meta charset="UTF-8">
<title>Rejected Enrollments</title>
<style>
...
<div class="sidebar">
  ...
  <a href="rejected_enrollments.php" class="active">❌ Rejected</a>
  <a href="admin_logout.php">🚪 Logout</a>
</div>

<div class="main-content">
  <div class="navbar">
    <div class="logo"><img src="../images/login.jpg" alt="Logo"> Rejected Enrollments</div>
  ...
  <div class="container">
    ...
    <div class="course-grid">
      <?php if($enrollments->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
      <?php else: ?>
        <p style="text-align:center; font-size:18px; color:#444;">No rejected enrollments.</p>
      <?php endif; ?>
    </div>
  </div>
